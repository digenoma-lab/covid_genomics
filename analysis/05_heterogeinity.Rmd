---
title: "Variants and heterogeneity in samples"
...
Using handmade curated data of important mutations in COVID genes (Spike, ORF3a, Envelope, Membrane, ORF6, ORF7a, ORF7b, ORF8) We are going to check if some of this mutations and variants are present in our samples.
...
### Generate vcf file
To run snpeff is neccesary to have a vcf file. In R we transform the file windows_variants_freyja.tsv into a vcf file.
...
The information that we need is in a column named INFO and is a single string with multiple entries, so we need to split this information before to work with it, this was made in python.
...
We come back in R to merge both datasets: snpeff output and curated mutations data.
...
Now, we are going to use our table filtrated to analyse some data: how many samples has different mutations in genes: Spike, ORF3a, Envelope, Membrane, ORF6, ORF7a, ORF7b, ORF8.
